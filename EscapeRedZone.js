...
function preload() {
  // preload() runs once
cool=loadImage("https://i.imgur.com/0vMvRrj.jpg", "jpg");
train=loadImage("https://i.imgur.com/Amf75zb.jpg", "jpg");
trav=loadImage("https://i.imgur.com/wnbsefV.png", "png");
...
function draw() {
  ...
  for (i=0; i<Ntrav; i++) {
    ...
    if (SamePoint(player.pos, travellers[i].pos)& (!win)) lost=true;
  }
